...
//          ;
  ...
  void updateContact() async {
    Contact? ninja = _contacts.firstWhere((contact) =>
        contact.familyName != null
            ? contact.familyName!.startsWith('Ninja')
            : false);
    ninja.avatar = null;
...
class ContactDetailsPage extends StatelessWidget {
  // const ContactDetailsPage(this._contact, {required this.onContactDeviceSave});

  final Contact _contact;
  final Function(Contact) onContactDeviceSave;

  const ContactDetailsPage(this._contact,
      {super.key, required this.onContactDeviceSave});
